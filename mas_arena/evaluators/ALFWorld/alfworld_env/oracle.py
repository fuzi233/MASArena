...
from .misc import extract_admissible_commands_with_heuristics
...
class OracleAgent(BaseAgent):
    ...
    def get_openable_points(self, traj_data):
        ...
        openable_json_file = os.path.join(os.path.dirname(__file__), '..', 'layouts', 'FloorPlan%d-openable.json' % scene_num)
